...
export default function Summary({ items, selectedIds, billTotal }: Props) {
  ...
  if (selectedIds.size === 0) {
    return (
      <div className="fixed inset-x-0 bottom-0 border-t border-gray-200 bg-white/80 px-4 py-5 text-center text-sm text-gray-400 backdrop-blur-xl">
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 border-t border-gray-200 bg-white/90 backdrop-blur-xl">
